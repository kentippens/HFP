...
return [
    ...
    'settings' => [
        ...
        'admin' => [
            ...
            'HTML.Allowed' => 'div[class|id|style],b,strong,i,em,u,a[href|title|target|class],ul[class|style],ol[class|style],li[class|style],p[style|class],br,span[style|class],img[width|height|alt|src|class],h1[class|id],h2[class|id],h3[class|id],h4[class|id],h5[class|id],h6[class|id],blockquote[class],pre[class],code[class],table[class|style],thead,tbody,tfoot,tr[class],td[colspan|rowspan|class|style],th[colspan|rowspan|class|style],iframe[src|width|height|frameborder]',
            ...
            'Output.TidyFormat' => false,
            'Attr.EnableID' => true,
            // Removed Attr.AllowedClasses - defaults to null which allows all classes
            // HTML5 elements not supported by HTMLPurifier - removed from HTML.Allowed
        ],
        
        // Service content configuration - copy of admin for pool service descriptions
        'services' => [
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'div[class|id|style],b,strong,i,em,u,a[href|title|target|class],ul[class|style],ol[class|style],li[class|style],p[style|class],br,span[style|class],img[width|height|alt|src|class],h1[class|id],h2[class|id],h3[class|id],h4[class|id],h5[class|id],h6[class|id],blockquote[class],pre[class],code[class],table[class|style],thead,tbody,tfoot,tr[class],td[colspan|rowspan|class|style],th[colspan|rowspan|class|style],iframe[src|width|height|frameborder]',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding,padding-left,padding-right,padding-top,padding-bottom,color,background-color,background,text-align,margin,margin-left,margin-right,margin-top,margin-bottom,border,border-width,border-color,border-style,display,width,height,max-width,max-height,min-width,min-height,float,clear,vertical-align,overflow,position,left,right,top,bottom,z-index',
