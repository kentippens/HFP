...
class LandingPage extends Model
{
     ...
     */
    protected $htmlFields = ['content', 'hero_content', 'cta_content'];

    /**
     * Fields that should be stripped of HTML
     */
    protected $stripFields = ['title', 'meta_title', 'meta_description', 'hero_title', 'cta_title'];

    /**
     * Purifier config to use for this model
     */
    protected $purifierConfig = 'admin'; // Admin config for landing pages
    ...
    public static function rules($id = null)
    {
        return [
            ...
            'slug' => 'required|string|max:255|unique:landing_pages,slug' . ($id ? ',' . $id : ''),
            ...
            'is_active' => 'boolean',
            'conversion_tracking_code' => 'nullable|string'
        ];
    }
