...
@section('service-content')
    ...
    <div class="pera-text mt-20">
        {{-- Custom content for Pool Tile Remodeling --}}
        <h4>Professional Pool Tile Remodeling Services</h4>
        <p>Experience our exceptional pool tile remodeling services designed to meet your specific pool renovation needs.</p>
