...
@section('service-content')
    ...
    <div class="pera-text mt-20">
        {{-- Custom content for Plaster & Marcite Resurfacing --}}
        <h4>Professional Plaster & Marcite Resurfacing Services</h4>
        <p>Experience our exceptional plaster & marcite resurfacing services designed to meet your specific pool renovation needs.</p>
